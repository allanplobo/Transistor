...
//   var x = document.getElementById('ArrowUp');
  ...
  return (
    <div className="DivPrincipal">
      <div className="RetanguloDegrade">
        ...
        <img
          src={PrimeiraPenaE}
          className="PrimeiraPenaEsquerda"
          alt="Card - Pena Esquerda"
        ></img>
        <img
          src={SegundaPenaE}
          className="SegundaPenaEsquerda"
          alt="Card - Segunda Pena Esquerda"
        ></img>
        <img
          src={PrimeiraPenaD}
          className="PrimeiraPenaDireita"
          alt="Card - Pena Direita"
        ></img>
        <img
          src={SegundaPenaD}
          className="SegundaPenaDireita"
          alt="Card - Segunda Pena Direita"
        ></img>
      </div>
      <img
        src={ImagemFundoPrincipal}
